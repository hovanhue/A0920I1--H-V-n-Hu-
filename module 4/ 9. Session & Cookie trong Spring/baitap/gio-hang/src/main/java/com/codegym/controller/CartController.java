...
public class CartController {
    ...
    @GetMapping("/buy/{id}")
    public String addCart(@PathVariable(value = "id") Long id, @SessionAttribute("carts") HashMap<Long, Cart> cartHashMap , Model model){
        if (cartHashMap == null){
    ...
    public String deleteCart(@PathVariable(value = "id") Long id, @SessionAttribute("carts") HashMap<Long,Cart> cartHashMap ,  Model model){
        if (cartHashMap == null){
            cartHashMap = new HashMap<>();
        }
