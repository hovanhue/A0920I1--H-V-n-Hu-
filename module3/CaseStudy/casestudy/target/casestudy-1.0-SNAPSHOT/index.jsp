                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggler" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/save">Add new employee</a>
    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./customer/img/1.jpg">
            </div>
            <div class="carousel-item">
                <img src="./customer/img/2.jpg">
            </div>
            <div class="carousel-item">
                <img src="./customer/img/3.jpg">
            </div>
            <div class="carousel-item">
                <img src="./customer/img/4.jpg">
            </div>
        </div>
    </div>
        <hr class="my-4">
